...
interface RunState {
  ...
  createRun: (body: { mode: string; task: string; repo?: string; fanout?: number; models?: string[]; reasoning?: Record<string, string>; images?: string[]; idempotency_key?: string }) => Promise<Run>;
}
